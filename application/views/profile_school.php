                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="profile-user-img">
                                    <a href="<?= base_url(); ?>Page/changeDP">
                                        <img src="<?= base_url(); ?>uploads/profile/<?= $this->session->userdata('image'); ?>" alt="" class="avatar-lg rounded-circle">
                                    </a>
                                </div>
                                <div class="">
                                    <h4 class="mt-5 font-18 ellipsis"><?php echo $data[0]->schoolID . ' ' . $data[0]->schoolName; ?></h4>
                            ...
                            <div class="col-sm-6">
                                <div class="text-right">
                                    <a href="<?= base_url(); ?>Page/schoolInfo?schoolid=<?php echo $data[0]->schoolID; ?>">
                                        ...
                                        <table class="table table-condensed mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $data[0]->adminFName . ' ' . $data[0]->adminMName . ' ' . $data[0]->adminLName; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">School Head Designation</th>
                                                    <td>
                                                        <?php echo $data[0]->adminDesignation; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">School Head Email</th>
                                                    <td>
                                                        <?php echo $data[0]->adminEmail; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">School Email</th>
                                                    <td>
                                                        <?php echo $data[0]->schoolEmail; ?>
                                                    </td>
                                                </tr>
