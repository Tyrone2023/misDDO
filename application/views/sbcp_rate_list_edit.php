            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?= form_open('Page/sbcp_list_edit', $att); ?>
                        ...
                        <input type="hidden" value="<?= $sbcpl->id; ?>" name="id">
                                                                                ...
                                                                                <?php $ivy=1; $ren=1; $r=0; foreach($smcp_func as $frow){
                                                                                    ...
                                                                                    <tr <?php echo (++$r%2 ? "" : "class='table-info'"); ?>>
                                                                                        ...
                                                                                        <td class="text-center">
                                                                                            ...
                                                                                            <input type="radio" name="q<?= $c; ?>" <?php if($sbcpl->$name == 1){echo " checked ";} ?> value="1" >
                                                                                        </td>
                                                                                        <td class="text-center"><input type="radio" <?php if($sbcpl->$name == 2){echo " checked ";} ?> name="q<?= $c; ?>" value="2" ></td>
                                                                                        <td class="text-center"><input type="radio" <?php if($sbcpl->$name == 3){echo " checked ";} ?> name="q<?= $c; ?>" value="3" ></td>
                                                                                    </tr>
                                                                                <?php } ?>
