                        ...
                        <div class="card-body">
                            ...
                            <div class="district-filter-bar mb-3">
                                <div class="district-filter-inner">
                                    <label for="districtFilter" class="filter-label mb-0">Filter by District:</label>
                                        ...
                                        foreach ($data as $row):
                                            if ($row->patientType == 'Student'): ?>
                                                <tr>
                                                    ...
                                                    $isTransferredReferred = in_array($dispositionNorm, ['transferred/referred', 'transferred / referred', 'referred', 'transferred'], true)
                                                        || strpos($dispositionNorm, 'referred') !== false;
                                                    ?>
                                                    <td>
                                                        <?php if ($isTransferredReferred): ?>
                                                    ...
                                                    <td>
                                                        <?php if ($isTransferredReferred): ?>
                                                            <?= htmlspecialchars($row->referral_guardian ?? '') ?>
                                                        <?php else: ?>
                                                            <span class="text-muted">-</span>
                                                        <?php endif; ?>
                                                    </td>
                                                        ...
                                                        <?php if ($user_sp == 0): ?>
                                                            <?php if ($row->consultationStat == 'Processed'): ?>
                                                                ...
                                                                <a href="#"
                                                                    ...
                                                                    data-report-referral="<?= $isTransferredReferred ? base_url() . 'Page/med_patient_referral?medID=' . $row->medID . '&download=1' : ''; ?>"
