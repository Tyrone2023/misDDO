                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-4">Memo Update</h4>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Memo No.</label>
                                            <input type="text" required name="memoNo" value="<?= $data[0]->memoNo; ?>" class="form-control" />
                                        </div>

                                      
                                        <div class="form-group col-md-12">
                                            <label>Title</label>
                                            <textarea id="title" name="title" class="form-control"> <?= $data[0]->title; ?></textarea>
                                        </div>
