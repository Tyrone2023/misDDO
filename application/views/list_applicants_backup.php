                                    ...
                                    <h4 class="header-title mb-4">List of Applicants<br /><span class="float-left badge badge-primary inline mt-2"><?php echo $_GET['jobTitle']; ?></span></h4><br />
                                        ...
                                        <tbody>
                                            ...
                                            <td style="text-align:center">
                                               ...
                                               <a href="<?= base_url(); ?>pages/<?= $user; ?>/<?= $id; ?>/<?= $row->jobID; ?>/<?= $row->pre_school; ?>" target="_blank" class="btn btn-info tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View Applicant Information"><i class="fas fa-file-alt"></i></a>&nbsp;&nbsp;
                                               <?php 
