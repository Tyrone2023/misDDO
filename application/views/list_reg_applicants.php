                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php foreach ($data as $row) { 
                                                    // $check = $this->Common->three_cond_count_row('hris_staff','LastName',$row->LastName,'FirstName',$row->FirstName,'MiddleName',$row->MiddleName);
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($this->session->position == 'del'){?>
