    ...
    ?>
        ...
        <div class="navbar-custom">
            ...
            <div class="logo-box">
                ...
                <a href="#" class="logo text-center logo">
                    <span class="logo-lg">
            ...
            <div class="slimscroll-menu">
                ...
                <div id="sidebar-menu">
                    <ul class="metismenu" id="side-menu">
                        ...
                        <?php if ($this->session->position === 'Admin' || $this->session->position === 'HR Staff' || $this->session->position === 'Human Resource Admin') : ?>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <!-- <li><a href="<?= base_url(); ?>Page/manage_evaluator">Manage Evaluator</a></li> -->
                    ...
                    <?php elseif ($this->session->userdata('position') === 'smme') : ?>
                        ...
                        <?php elseif ($this->session->position === 'District' || $this->session->position === 'Evaluator') : ?>
