...
<html lang="en">
    ...
    <table width="100%">
        <?php 
            ...
            $mb = ($abp->mb >= 1 && $abp->mb <= 9) ? '.0'.$abp->mb : '.'.$abp->mb;
            $mr = ($abp->mr >= 1 && $abp->mr <= 9) ? '.0'.$abp->mr : '.'.$abp->mr;
            $tlip = ($abp->tli >= 1 && $abp->tli <= 9) ? '.0'.$abp->tli : '.'.$abp->tli;
            $tst = ($abp->tst >= 1 && $abp->tst <= 9) ? '.0'.$abp->tst : '.'.$abp->tst;
        ...
        <tbody >
            ...
            <tr>
                ...
                <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td colspan="3" class="pt">Mode of procurement</td><td colspan="2"><?= $row->procurement; ?></td>
            </tr>
            <?php 
