                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?= form_open('page/smea_adjustment_update'); ?>
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="value1" oninput="calculateTotal()" name="q1" class="form-control amount" value="<?= $data->q1; ?>" >
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="value2"  oninput="calculateTotal()" name="q2" class="form-control amount" value="<?= $data->q2; ?>" >
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="value3"  oninput="calculateTotal()" name="q3" class="form-control amount" value="<?= $data->q3; ?>" >
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="value4" oninput="calculateTotal()" name="q4" class="form-control amount" value="<?= $data->q4; ?>" >
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
