                            ...
                            <div class="col-12">
                                ...
                                <?php if($this->session->flashdata('success')) : ?>
                                    ...
                                    <?php if($this->session->position == 'Admin' || $this->session->position == "Accountant" || $this->session->position == "smme"){ ?>
                                        ...
                                        <a href="<?= base_url(); ?>Page/sned_approved" class="btn btn-purple">APPROVED SNED</a>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $row->date; ?></td>  
                                                        <td>
                                                        <?php if($this->session->position == "Admin" || $this->session->position == "Accountant" || $this->session->position == "smme" || $this->session->position == "sned" || $this->session->position == "sbfp"){ ?>
                                                            ...
                                                            <?php //if($row->status != 1){ ?>
                                                                ...
                                                                <?php if($row->status != 1){?>
                                                                    <a href="<?= base_url(); ?>Page/approved_aip_sned/<?= $row->id; ?>/<?= $row->school_id; ?>" class="btn btn-warning" onclick="return confirm('Are you sure?')">Approved</a>&nbsp;
                                                                <?php } ?>
                                                                <?php //} else { ?> 
