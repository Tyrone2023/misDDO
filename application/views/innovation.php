                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php if($this->session->flashdata('success')) : ?>
                                    ...
                                    <a href="<?= base_url().'Page/innovation_new' ?>"><button type="button" class="btn btn-primary waves-effect waves-light" >Add Innovations</button></a>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $values[$row->bedp]; ?></td>
                                                        <td><?= $row->fy; ?></td>
                                                        <td><?= $row->recipient; ?></td>
                                                        <td><?= $row->impact; ?></td>
                                                        <td>
                                                        <a class="btn btn-success sm" href="<?= base_url(); ?>Page/innovation_update/<?= $row->id; ?>">EDIT</a>  &nbsp;
                                                        <a class="btn btn-danger sm" onclick="return confirm('Are you sure?')" href="<?= base_url(); ?>Page/innovation_delete/<?= $row->id; ?>">DELETE</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
