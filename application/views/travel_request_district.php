                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($row->status == 'Pending'){ ?>
                                                   ...
                                                   <?php }else{?>
                                                   <a onclick="return confirm('Are you sure?')" href="<?= site_url('travel/action_travel/' . $row->id) ?>/Endorsed" class="btn btn-sm btn-primary" target="_blank">Endorsed</a>
                                                   <?php } ?>
