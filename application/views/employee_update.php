                            ...
                            <div class="col-md-12">
                                <div class="card">
									...
									<div class="row">
										...
										<input type="hidden" class="form-control" name="id" readonly required value="<?= $app->IDNumber; ?>">
										<div class="col-lg-3">
												<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-lg-3">
											...
											<label>Mobile No.</label>
											 <input type="text" class="form-control" name="empMobile" value="<?= $app->empMobile; ?>" >
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
											<label>E-mail <span class="ren_r">*</span></label>
											 <input type="email"  class="form-control" name="empEmail" value="<?= $app->empEmail; ?>" required >
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
									 ...
									 <div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
											<label>Item No.</label>
											 <input type="text" class="form-control" name="itemNo" value="<?= $app->itemNo; ?>" >
											</div>
										</div>
										<div class="col-lg-2">
												<div class="form-group">
