    ...
    <div class="inner">
        ...
        <table class="data">
            ...
            <tr>
                ...
                <td><?= number_format($row->interview+$row->written, 2); ?></td>
                <td><?= number_format(($row->total_points != 0.00001) ? $row->total_points : "", 2); ?></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
        ...
        <table class="sign">
            <tr>
                <td><?php if($this->uri->segment(4) == 1){?><img class="isig isig3" src="<?= base_url(); ?>assets/isig/chona.png" alt=""><?php } ?><br /><span><?= strtoupper($sign->m1n); ?></span><br /><?= $sign->m1p; ?><br />Member</td>
