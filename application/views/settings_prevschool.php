                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">
                                    <a href="<?= base_url(); ?>Page/Addprevschool">
                                                    ...
                                                    <?php foreach ($data as $row) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?= base_url('Page/updateprevschool?schoolID=' . $row->schoolID); ?>"
                                                                    class="btn btn-primary waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i>Edit</a>

                                                                <a href="#" class="btn btn-danger waves-effect waves-light btn-sm" data-toggle="modal" data-target="#confirmationModal" onclick="setDeleteUrl('<?= base_url('Page/Deleteprevschool?schoolID=' . $row->schoolID); ?>')">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?= base_url('Page/Deleteprevschool?schoolID=' . $row->schoolID); ?>); ?>" class="btn btn-danger" onclick="deleteData()">Delete</a>
                        </div>
                    </div>
                </div>
            </div>
