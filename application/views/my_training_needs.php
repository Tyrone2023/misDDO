                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="header-title mb-4">My Training Needs</h4><br />
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data as $row) {
                                                    echo "<tr>";
                                                    echo "<td>" . $row->trainingNeeds . "</td>";
                                                    echo "<td>" . $row->trainingCat . "</td>";
                                                    echo "<td>" . $row->justification . "</td>";
                                                ?>

                                                    <td style="text-align:center">
                                                        <a href="delete_tn?id=<?php echo $row->tnID; ?>" class="text-danger"><i class="mdi mdi-file-document-box-check-outline"></i>Delete</a>
                                ...
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select class="form-control" name="trainingCat" required>
                                                <option></option>
