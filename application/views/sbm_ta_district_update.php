            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?= form_open('Page/tapr_district_update', $att); ?>
                                                                            ...
                                                                            <tbody>
                                                                                <?php 
                                                                                    ...
                                                                                    foreach($question as $sub_row){
                                                                                        ...
                                                                                        $sbm = $this->Common->two_cond_row('sbm','school_id',$this->uri->segment(3),'fy',$_SESSION['sbm_fy']);
                                                                                ...
                                                                                <tr <?php echo (++$c%2 ? "" : "class='table-active'"); ?>>
                                                                                    ...
                                                                                    <td><textarea class="form-control" name="q<?=$sub_row->i_no; ?>"  rows="2" id="example-textarea" readonly><?= $sbm_ta->$count; ?></textarea></td>
                                                                                    <td><textarea class="form-control" name="qq<?=$sub_row->i_no; ?>" rows="2" id="example-textarea" readonly><?= $sbm_ta->$count1; ?></textarea></td>
                                                                                    <td>
                                                                                    <select class="form-control" name="a<?=$sub_row->i_no; ?>" disabled>
                                                                                        <option></option>
                                                                                        <?php foreach($cat as $row){ ?>
                                                                                            <option <?php if($sbm_ta->$count2 == $row){echo " selected ";}?> value="<?= $row; ?>"><?= $row; ?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                    </td>
                                                                                    <td><textarea class="form-control" name="f<?=$sub_row->i_no; ?>" rows="2" id="example-textarea" readonly><?= $sbm_ta->$count3; ?></textarea></td>
