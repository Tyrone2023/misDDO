                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <h4 class="header-title mb-4">Processed Travel Requests</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row->status === 'Returned'): ?>
                                                    ...
                                                    <span class="text-danger"><?= $row->asds_comments ?></span>
                                                <?php elseif ($row->status === 'Approved'): ?>
                                                    <a href="<?= site_url('travel/print/' . $row->id) ?>" class="btn btn-sm btn-success" target="_blank">Print</a>
                                                <?php endif; ?>
                                            </td>
