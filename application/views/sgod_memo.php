                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <td><?= $row->memoNo; ?></td>
                                                    ...
                                                    <?php } else { ?>
                                                        <a class="btn btn-warning btn-sm tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Update File Attachment" href="<?= base_url(); ?>page/memo_file_update/<?= $row->id; ?>"><i class="fas fa-file-pdf"></i></a>   
                                                        <a class="btn btn-success btn-sm tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment" href="<?= base_url(); ?>uploads/sgod_memo/<?= $row->fileName; ?>" target="_blank"><i class="fas fa-file-pdf"></i></a>
                                                    <?php } ?> 
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text"  required name="memoNo" class="form-control" value="<?= $ln->memoNo; ?>"/>
                                                        </div>
