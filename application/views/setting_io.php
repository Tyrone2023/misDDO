                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="modal" data-field="<?= $row->description; ?>" data-id="<?= $row->id; ?>" class="open-AddBookDialog text-primary" href="#app_edit"><i class="mdi mdi-file-document-box-check-outline"></i>Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label >Pillar</label>
                                                            <select class="form-control" name="pillar_id" required>
                                                                <option></option>
                                                                <?php foreach($pillar as $row){
                                                                    echo "<option value='".$row->id."'>".$row->pillar."</option>";
                                                                   }
                                                                ?>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group col-md-12">
                                                            <label><?= $label; ?></label>
                                                            <input type="text"  id="field" name="description" class="form-control" value="" />
                                                        </div>
