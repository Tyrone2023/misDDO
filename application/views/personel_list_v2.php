                                            ...
                                            <tbody>
                                                ...
                                                <td><?= ucfirst($row['LastName']).', '.ucfirst($row['FirstName']).' '.ucfirst(substr($row['MiddleName'],0,1)); ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="Pages/personel_del/<?= $row['IDNumber']; ?>" class="text-danger" onclick="return confirm('Are you sure?')"><i class="mdi mdi-file-document-box-check-outline"></i>Delete</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
