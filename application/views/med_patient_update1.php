                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <form method="post" action="<?= base_url('Page/med_patient_update1?medID=' . urlencode($data[0]->medID)); ?>" enctype="multipart/form-data">
                                ...
                                <!-- (Optional safety) keep identity fields if your update handler expects them -->
                                ...
                                <?php else: ?>
                                    <!-- Nurse: only show Current Medication; hide others but keep keys -->
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label class="col-form-label">CURRENT MEDICATION</label>
                                            <input type="text" class="form-control" name="current_med" value="<?php echo $data[0]->current_med; ?>">
                                ...
                                <?php if ($isNurseRole): ?>
                                    <!-- ✅ Nurse: make last 3 equal width + equal height -->
