                                ...
                                <div class="card">
                                    ...
                                    <div class="form-group text-left mb-0">
                                        ...
                                        <?php } }else{ ?>
                                            ...
                                            <a href="<?= base_url(); ?>/Page/sbm_checklist_unlock/<?= $sbmc->id; ?>/<?= $sbmc->school_id; ?>" onclick="return confirm('Are you sure?')" class="btn btn-success waves-effect waves-light mr-1">Unlock</a>
                                        <?php }} ?>  
