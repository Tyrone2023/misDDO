                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            <h5 class="text-uppercase font-weight-bold"><?= $staff->FirstName.' '. $staff->LastName; ?></h5>
                            <div class="designation mb-4">POSITION : <?= $staff->empPosition; ?>
                            <br />DEPARTMENT : <?= $staff->Department; ?></div>
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    <?php foreach ($requests as $row): ?>
                                        <tr>
                                            <td><?= smartTitleCase($row->purpose) ?></td>
