...
<head>
  ...
  <!-- AIP plan pages (approved list, unlock requests, the school's plan page and
       the tracking modal they all share). -->
  <link href="<?= base_url(); ?>assets/css/aip-plans.css?v=1" rel="stylesheet" type="text/css" />
  ...
  <link href="<?= base_url(); ?>assets/css/mis-modern.css?v=3" rel="stylesheet" type="text/css" />
