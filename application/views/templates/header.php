<body>
    ...
    <div id="wrapper">
        ...
        // Names of everyone who commented, in ONE query. This used to be a lookup per
        // notification row inside the dropdown loop below — with ~1,100 unread rows that
        // was ~1,100 queries, and it held the whole page back by several seconds before
