                                        ...
                                        <tbody>
                                          ...
                                          <td style="text-align: center">
                                            ...
                                            <?php }else{ ?>
                                                            ...
                                                            <a href="<?= base_url(); ?>Pages/rqa_municipality_track?id=<?= $row->jobID; ?>&mun=<?= $row->resCity; ?>&spec=<?= $row->shss; ?>" class="text-primary" target="_blank"><i class="mdi mdi-file-document-box-check-outline"></i>Printable View</a>&nbsp;&nbsp;&nbsp;&nbsp;
