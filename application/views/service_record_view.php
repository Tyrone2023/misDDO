    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body table-responsive">
                <h4 class="header-title mb-4">SERVICE RECORD<br/> <br>
                  <span>
                  <strong><?php echo $data[0]->FirstName; ?> <?php echo $data[0]->MiddleName; ?> <?php echo $data[0]->LastName; ?></strong>
                  </span>
                </h4><br />
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <strong class="modal-title" id="myLargeModalLabel">Add New Service Record for <?php echo $data[0]->FirstName; ?> <?php echo $data[0]->MiddleName; ?> <?php echo $data[0]->LastName; ?></strong>
                                                   ...
                                                   <div class="form-row">
                                                       ...
                                                       <input type="hidden" required name="IDNumber" class="form-control" value="<?= $data[0]->IDNumber; ?>" >
