                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                    <div class="card-body table-responsive">
                                                                        <?php $summary = $this->Coor_model->get_summary_by_level_subject_by_district(7,$q); ?>
                                                                    <h4 class="header-title mb-4">Division-Level Consolidated Proficiency Report</h4>
                                                                    <?php $d = $this->Common->one_cond_row('district','id',$this->session->c_id); ?>
                                                                        ...
                                                                        <table class="table table-bordered mb-0">
                                                                            ...
                                                                            <tbody>
                                                                                <?php for ($i = 1; $i <= 12; $i++): ?>
                                                                                    <?php $sum_gl = $this->Coor_model->get_summary_district_by_grade_level(7,$q,$i); ?>
                                                                                    <tr>
                                                                                ...
                                                                                <?php endfor; ?>
                                                                                <tr>
                                                                                    <th class="text-right"><a href="<?= base_url(); ?>Coor/math_coor_proficiency_schoollist_report/<?= $q; ?>/<?= $this->uri->segment(3); ?>/?district=<?= $d->discription; ?>">TOTAL</a></th>
