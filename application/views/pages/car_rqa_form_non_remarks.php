...
<?php foreach ($car as $row): ?>
    ...
    <tr>
        ...
        <td class="remarks-cell"><textarea class="remarks-input" rows="1" data-record="<?= htmlspecialchars($row->code, ENT_QUOTES); ?>"><?= htmlspecialchars($remarks_map[(string) $row->code] ?? (($oa->num_rows() >= 1) ? "SY 2024-2025 Applicant" : ""), ENT_QUOTES); ?></textarea></td>
