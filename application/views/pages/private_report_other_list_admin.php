                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#yourmodal">Add New</button>
                                         ...
                                         <table class="table table-bordered mb-0">
                                            <tbody>
                                                <?php $ic=1; foreach($data as $row){
                                                    $entry = $this->Common->two_cond_count_row('private_other_data','pq_id',$row->id,'school_id',$this->uri->segment(3));
                                                    ?>
                                                <tr>
                                                    <td><?= $ic++; ?></td>
                                                    <td>
                                                        <a class="text-info" href="<?= base_url(); ?>Ps/private_entry_list_other_admin/<?= $row->id; ?>/<?= $this->uri->segment(3); ?>"><?= $row->question; ?></a> <?php if($entry->num_rows() != 0){ ?><span class="badge badge-purple"><?= $entry->num_rows(); ?></span><?php } ?> 
                                                        <?php if($this->session->position == 'smme'){ ?><a onclick="return confirm('Are you sure?')" href="<?= base_url(); ?>Ps/private_indicator_delete/<?= $row->id; ?>" class="text-danger"> <i class="mdi mdi-trash-can-outline"></i>Delete</a> <?php } ?>
