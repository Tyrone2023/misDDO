                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="float-left mt-4">
                                                    <p><strong>Borrower's Name: </strong><?= $staff->FirstName; ?> <?= $staff->MiddleName; ?> <?= $staff->LastName; ?>  </p>
                                                    <p class="mt-2"><strong>Station code: </strong>  </p>
                                                    <p class="mt-2"><strong>District/School </strong>  </p>
                                                    <p class="mt-2"><strong>Loan Amount: </strong>&#8369; <?= $data->principalAmount; ?> </p>
                                                    <p class="mt-2"><strong>Interest: </strong>&#8369; <?= number_format($totalInterest, 2); ?></p>
                                                    <p class="mt-2"><strong>Scheduled Payment: </strong>&#8369; <?= number_format($monthlyPayment, 2) . PHP_EOL; ?></p>
                                                    <p class="mt-2"><strong>Loan Period: </strong>  <?= $ivankyle; ?> Years</p>
                                                </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table mt-4">
                                                        ...
                                                        <tbody class="text-center">
                                                            ...
                                                            // --- Starting values ---
                                                            $balance = (float) $data->principalAmount;     // principal
                                                            ...
                                                            for ($i = 0; $i < $loanMonths; $i++) {
                                                                ...
                                                                $paymentAmt = $row ? round((float) $row->dedAmount, 2) : round((float) $monthlyPayment, 2);
