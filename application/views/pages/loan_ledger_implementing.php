                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="float-left mt-4">
                                                    <p style="margin:0"><strong>Borrower's Name: </strong><?= $staff->FirstName; ?> <?= $staff->MiddleName; ?> <?= $staff->LastName; ?>  </p>
                                                    ...
                                                    <p class="mt-2" style="margin:0 !important"><strong>Loan Amount: </strong>&#8369; <?= number_format($data->principal,2); ?> </p>
                                                        ...
                                                        <tbody class="text-center">
                                                            <?php
                                                                ...
                                                                foreach ($payment as $k => $row) {
                                                                    ...
                                                                    $ivan = $this->Common->two_cond_row('provident_ledger','dedID',$data->id,'type',1);

                                                                    $paymentAmt = round((float) $row->amount, 2);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php 
                                                                            ...
                                                                            $monthWord = date("M", mktime(0, 0, 0, $monthNum, 1));
                                                                    ...
                                                                    <td>
                                                                        <?php $opinfo = $this->Common->three_cond_row('provident_add_info','month',$row->month,'fy',$row->fy,'school_id',$this->uri->segment(3));  ?>
                                                                        <?php if ($isLastRow): ?>
                                                                            <?php if ($ivan): ?>
                                                                                    <a href="#"
                                                                                    ...
                                                                                    <?php if($opinfo){?>
                                                                                        ...
                                                                                        <a target="_blank" href="<?= base_url(); ?>Provident/order_of_payment_single/<?= $this->uri->segment('3'); ?>/<?= $row->month; ?>/<?= $row->fy; ?>/<?= rawurlencode((string)$reverse); ?>/<?= $school->schoolID; ?>"><i class="fas fa-money-check-alt text-info"></i></a> 
                                                                                    <?Php }else{ ?>
                                                                                        <a href="#" class="open-AddBookDialog" data-toggle="modal" data-id="<?= $row->month; ?>" data-item="<?= $row->fy; ?>" data-target="#addinfo"><i class="fas fa-file-signature text-info"></i></a>
                                                                                    <?php } ?>
                                                                                    <?php else: ?>
                                                                                    <a href="#"
