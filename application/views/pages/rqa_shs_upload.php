        ...
        <div class="container-fluid rqa-page-shell">
            ...
            <div class="rqa-hero">
                <div class="rqa-hero-content">
                    <div class="rqa-title-block">
                        <h4><?= h($title ?? 'RQA SHS Strand and Major Upload'); ?></h4>
                        <p>Upload the CAR-RQA SHS workbook to update applicant SHS strand and Major values by Application Code.</p>
                    </div>
            ...
            <div class="card rqa-card">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('Pages/rqa_shs_upload_import'); ?>" method="post" enctype="multipart/form-data">
