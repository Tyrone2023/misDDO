<!-- ============================================================== -->
            ...
            // }
            ?>
            <?php $a = $this->Common->find_record_no_identity($this->uri->segment(7)); ?>
                                            ...
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="background: #9ddcf4; color:#222"><?= strtoupper($a->fullname); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th width="30%" class="text-right">Application Code</th>
                                                        <td style="background: #9ddcf4; color:#222"><?= strtoupper($this->uri->segment(7)); ?></td>
                                                    </tr>
                                                    <tr>
