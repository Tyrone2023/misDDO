...
<div class="wrap">
    <div class="appendix">
        ...
        <table>
            ...
            <tr>
                <td colspan="4" class="text-right">Please issue Official Receipt in favor of  <?php $mi = !empty($staff->MiddleName) ? strtoupper(substr(trim($staff->MiddleName), 0, 1)) . '.' : ''; ?></td>
                <td colspan="4" class="bb bold"><?= strtoupper($staff->FirstName .' '.$mi.' '.$staff->LastName); ?></td>
            </tr>
            <tr>
                <td colspan="8"></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="5" class="bb con" style="font-size:12px"><?= numberToWords($amount); ?></td>
                <td class="bb">&#8369; <?= number_format($amount,2); ?></td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td colspan="5" class="bb">PROVIDENT FUND REMITTANCE FOR <?= $monthText = strtoupper(date("F", mktime(0, 0, 0, $month, 1))); ?> <?= $fy; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td colspan="2" class="dbb">&#8369; <?= number_format($amount,2); ?></td>
            </tr>
            <tr>
                <td colspan="8"></td>
            </tr>
