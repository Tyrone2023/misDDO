                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <a href="#" class="btn btn-purple waves-effect waves-light openModalBtn"data-toggle="modal" data-target="#ic">Add Payment</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a target="_blank" class="text-primary tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Whole Term Ledger " href="<?= base_url(); ?>Provident/loan_ledger_full_term_implementing/<?= $row->IDNumber; ?>/<?= $row->id; ?>"><i class="fas fa-file-invoice "></i></a> &nbsp; &nbsp;
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="">
                                                                    ...
                                                                    <input type="hidden" class="form-control" value="0007" name="deduction_code">
                                                                    <input type="hidden" class="form-control" value="<?= $this->session->username; ?>" name="school_id">
