                                    ...
                                    <span class="badge badge-info"><?= $job->jobTitle; ?></span>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $ad->num_rows();?></td>
                                                <td class="text-center"><a href="<?= base_url(); ?>Pages/rqa_cluster_list_jhsv2/<?= $this->uri->segment(3); ?>/?s=<?= $row->specialization; ?>" class="text-success"><i class="mdi mdi-file-document-box-check-outline"></i>Printable View</a></td>
                                            </tr>
                                            <?php } } ?>
                                        </tbody>
