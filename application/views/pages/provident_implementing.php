            ...
            <div class="content-page">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <a href="#" class="btn btn-purple waves-effect waves-light openModalBtn"data-toggle="modal" data-target="#ic">School Report</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a onclick="return confirm('Are you sure?')" class="text-danger tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete" href="<?= base_url(); ?>Provident/implementing_provident_delete/<?= $row->id; ?>"><i class="far fa-trash-alt"></i></a> &nbsp; &nbsp;
                                                        <?php } ?>
                                                        <a target="_blank" class="text-success tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View Ledger" href="<?= base_url(); ?>Provident/loan_ledger_implementing/<?= $row->IDNumber; ?>/<?= $row->id; ?>"><i class="fas fa-file-invoice "></i></a> &nbsp; &nbsp;
                                                        <a target="_blank" class="text-purple tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Whole Term Ledger " href="<?= base_url(); ?>Provident/loan_ledger_full_term_implementing/<?= $row->IDNumber; ?>/<?= $row->id; ?>"><i class="fas fa-file-invoice "></i></a> &nbsp; &nbsp;
                                                        <a target="_blank" class="text-primary tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Whole Term Ledger " href="<?= base_url(); ?>payment/<?= $row->id; ?>/<?= $row->IDNumber; ?>"><i class="far fa-money-bill-alt"></i></a> &nbsp; &nbsp;
                                                        <a onclick="return confirm('Are you sure?')" class="text-danger tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Paid" href="<?= base_url(); ?>Provident/loan_paid/<?= $row->id; ?>"><i class="fas fa-tools"></i></a> &nbsp; &nbsp;
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                ...
                <!-- sample modal content -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="">
                                                                    ...
                                                                    echo form_open('Provident/provident_imp_insert', $attributes);
                                                                    ?>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            ...
                                                                            <select name="school_id" class="form-control" data-toggle="select2" required>
                                                                                ...
                                                                                <option value="<?= $row->school_id; ?>"><?= strtoupper($row->name); ?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <input type="text" value="" oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g,'$1').replace(/^(\d+)(\.\d{0,2})?.*$/,'$1$2')" name="deduction" class="form-control">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <input type="text" value="" oninput="this.value=this.value.replace(/[^0-9]/g,'')" name="principal" class="form-control">
                                        ...
                                        <!-- sample modal content -->
                                        <div id="ic" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content modal-lg">
                                                    <div class="modal-header bg-info">
                                                        <h5 class="modal-title" id="modalTitle">Select School</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="">
                                                                    ...
                                                                    <?php
                                                                    $attributes = array('class' => 'parsley-examples form-horizontal');
                                                                    echo form_open('Provident/implementing_school_payment', $attributes);
                                                                    ?>
