<?php
    ...
    $currentJobType  = (!empty($job) && isset($job->job_type)) ? ($jobTypes[$job->job_type] ?? '') : '';
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-10 col-sm-12">
                                    <?php
                                        ...
                                        echo form_open_multipart('pages/request_rating_granted_none', $attributes);
                                    ?>
                                                ...
                                                <select class="form-control" required name="application">
                                                    ...
                                                    <?php if (!empty($application)) : ?>
                                                        <?php foreach ($application as $row) : ?>
                                                            <option value="<?= $row->appID; ?>"><?= $row->jobTitle; ?> - <?= $row->datePosted; ?></option>
                                                        <?php endforeach; ?>
                                                    <?php endif; ?>
                                                </select>
