                                         ...
                                         <table class="table table-bordered mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $ic++; ?></td>
                                                    <td>
                                                        <a class="text-info" href="<?= base_url(); ?>Ps/private_entry_list_other/<?= $row->id; ?>"><?= $row->question; ?></a> <?php if($entry->num_rows() != 0){ ?><span class="badge badge-purple"><?= $entry->num_rows(); ?></span><?php } ?> 
                                                    ...
                                                    <td class="text-center">
                                                        <a href="#" 
                                                            class="btn btn-primary waves-effect waves-light openModalBtn"
                                                            data-id="<?= $row->id; ?>"
                                                            data-question="<?= htmlspecialchars($row->question, ENT_QUOTES); ?>"
                                                            data-toggle="modal" 
                                                            data-target="#myModal">New Entry
                                                        </a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
