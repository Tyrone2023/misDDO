            ...
            <div class="rqa-hero">
                <div class="rqa-hero-content">
                    <div class="rqa-title-block">
                        <!-- <h4><?= h($title ?? 'For Issuance of Appointment (Observer)'); ?></h4> -->
                         <h4>For Issuance of Appointment</h4>
                        <p>Read-only view of approved applicants for appointment issuance. Date Hired and Waiver status update on their own as the issuing officer records them &mdash; no need to refresh.</p>
                    </div>
            ...
            <div class="card rqa-card rqa-results-card">
                <div class="card-body">
                    <div class="rqa-results-header">
                        <h5 class="rqa-section-title"><i class="mdi mdi-file-document-outline"></i> For Issuance of Appointment</h5>
                    </div>
