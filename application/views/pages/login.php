                                ...
                                <?= form_open('log_in') ?>
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-sm-12 text-center">
                                            <p class="text-muted mb-0"><a href="<?= base_url(); ?>Pages/forgot_password" class="text-dark m-l-5"><b>Forgot Password?</b></a></p><br />
                                            <?php if($page->status == 0){ ?>
                                            <p>Do you already have an account?<br /></p>
                                            <div class="button-list">
                                                <a class="btn btn-sm btn-info" href="<?= base_url('Pages/new_applicant'); ?>">Applicant's</a>
                                                <a class="btn btn-sm btn-purple" href="<?= base_url('private'); ?>">Private School</a>
                                            </div>
                                             <?php } ?>
