                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?= form_open('Pages/ier_update_info'); ?>
									<div class="row">
										...
										<div class="col-lg-2">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="etchnic" required value="<?= $ier->etchnic ?? '' ?>">
                                    ...
                                    <div class="col-lg-7">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="religion" required value="<?= $ier->etchnic ?? '' ?>">
									...
									<div class="row">
											<div class="col-lg-4">
												...
												<input type="text" class="form-control" name="ttitle" value="<?= $ier->ttitle ?? '' ?>" placeholder="Title">
												</div>
											</div>
											<div class="col-lg-3">
												<div class="form-group">
												<label>&nbsp;</label>
												<input type="text" class="form-control" name="thours" value="<?= $ier->thours ?? '' ?>" placeholder="Hours">
												</div>
											</div>
									...
									<div class="row">
											<div class="col-lg-3">
												...
												<input type="text" class="form-control" name="edetails" value="<?= $ier->edetails ?? '' ?>" placeholder="Details">
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
												<label>&nbsp;</label>
												<input type="text" class="form-control" name="eyears" value="<?= $ier->eyears ?? '' ?>" placeholder="Years">
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
												<label>&nbsp;</label>
												<input type="text" class="form-control" name="eeligibility" value="<?= $ier->eeligibility ?? '' ?>" placeholder="Eligibility">
												</div>
											</div>
                                    ...
                                    <input type="hidden" name="id" value="<?= $ier->id; ?>">
