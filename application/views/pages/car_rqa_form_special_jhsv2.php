...
<body>
 ...
 <td class="wb">Division of <?php echo $settings->division; ?></td>
        ...
        <table class="data">
            ...
            <?php foreach ($grouped_applicants as $jhss => $group): ?>
            <tr>
                <td colspan="17" style="text-align:left"><?= htmlspecialchars($jhss); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="rqa-cell"><input type="text" class="rqa-edit rqa-cell-edit" data-record="<?= htmlspecialchars($person->code, ENT_QUOTES); ?>" data-field="remarks_col" value="<?= htmlspecialchars($cells[(string) $person->code]->remarks_col ?? '', ENT_QUOTES); ?>"></td>
