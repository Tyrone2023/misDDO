                            ...
                            <div class="col-md-12">
                                <div class="card">
									...
									<div class="row">
										...
										<div class="col-lg-2">
											...
											<label>Auth. Annual Salary</label>
											 <input type="text" class="form-control" name="authAnSalary" value="" >
											</div>
										</div>
										<div class="col-lg-2">
											<div class="form-group">
											<label>Actual Salary</label>
											 <input type="text" class="form-control" name="actualSalary" value="" >
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-lg-3">
											...
											<label>Station Code </label>
											 <input type="text" class="form-control" name="stationCode" value="" >
											</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-4">
											...
											<label>Last Appointment</label>
											 <input type="date" class="form-control" name="lastAppointmentDate" value="" >
											</div>
										</div>
										<div class="col-lg-4">
											<div class="form-group">
									...
									<div class="col-lg-2">
											<div class="form-group">
											<label>UMID</label>
											 <input type="text" class="form-control" name="umid" value="" >
											</div>
										</div>
										<div class="col-lg-2">
											<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-lg-3">
											...
											<select class="form-control" name="csEligibility">
												<option></option>
												<?php 
                                                    $array = array('No Eligibility', 'PBET','RA 4670','RA 6850','RA 1080',
															'PD 907'); 
                                                                foreach($array as $ar){
                                                                    echo '<option>'. $ar . '</option>';
                                                                }
									...
									<div class="row">
											<div class="col-lg-3">
												...
												<input type="number" class="form-control" name="YearsAsJO" value="" >
												</div>
											</div>
										<div class="col-lg-3">
											<div class="form-group">
