                                    ...
                                    <span class="badge badge-info"><?= $job->jobTitle; ?></span>
                                        ...
                                        <tbody>
                                            <?php foreach($district as $row){  
                                                $app = $this->Common->four_cond_count_row('hris_applications', 'jobID', $this->uri->segment(3),'appStatus','Endorsed for Rating','district',$row->discription,'dq',1);
                                                if($app->num_rows() >= 1){
                                                ?>
                                                <tr>
                                                    ...
                                                    <?php } ?> -->
                                                        <a href="<?= base_url(); ?>Pages/endorsed_list/<?= $this->uri->segment(3); ?>/?district=<?= $row->discription; ?>" class="btn btn-info tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View Applicants"><i class="mdi mdi-file-document-box-outline"></i>View Applicants</a>
