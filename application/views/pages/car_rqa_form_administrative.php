  ...
  <div class="wrap">
    <div class="inner">
        ...
        <table class="data">
            ...
            <tr>
                <td><?= $no++; ?></td>
                <td class="name"><a style="text-decoration:none; white-space: nowrap; color:#222" target="_blank" href="<?= base_url(); ?>Pages/<?= $page; ?>/<?= $id; ?>/<?= $row->jobID; ?>/<?= $row->pre_school; ?>"><?= strtoupper($ap->FirstName).' '.strtoupper($ap->MiddleName).' '.strtoupper($ap->LastName).' '.strtoupper($ap->NameExtn); ?></a></td>
                <td><?= $row->record_no; ?> </td>
        ...
        <!-- <table class="sign">
            <?php $rqa_sign = $this->Common->one_cond_row('hris_rqa_sign', 'id', $job->sign); if($rqa_sign->nr == 1){?>
                <tr>
                    ...
                    <td><span><?= $sign->m3n; ?></span><br /><?= $sign->m3p; ?><br />Member</td>
                    <td></td>
                    <td><span><?= $sign->sdsn; ?></span><br /><?= $sign->sdsp; ?><br /><br /></td>
                </tr>
                <tr>
                    <td><span><?= $sign->m4n; ?></span><br /><?= $sign->m4p; ?><br />Member</td>
                    <td><span><?= $sign->m5n; ?></span><br /><?= $sign->m5p; ?><br />Member</td>
                    <td><span><?= $sign->asdsn; ?></span><br /><?= $sign->asdsp; ?><br />Chairperson</td>
                    <td></td>
                    <td></td>
                </tr>
            <?php }else{ ?>
