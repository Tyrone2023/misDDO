                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <?php if($this->session->position==='Human Resource Admin' || $this->session->position==='HR Staff' || $this->session->userdata('position')==='Super Admin' || $this->session->position==='asds'): ?>
                                        <!-- <a href="<?= base_url(); ?>Pages/hiring_non_qaulified" target="_blank" class="btn btn-info">Qualified List</a>
                                        <a href="<?= base_url(); ?>Pages/hiring_non_not_qaulified" target="_blank" class="btn btn-success">Not Qualified List</a>
                                        <a href="<?= base_url(); ?>Pages/hiring_non_qaulified_rated" target="_blank" class="btn btn-info">Qualified List Rated</a> -->
                                            ...
                                            //if(isset($a)){ 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank" href="<?= base_url(); ?>pages/<?= $row->st; ?>/<?= $row->id; ?>/<?= $row->jobID; ?>/<?= $row->pre_school; ?>/<?= $row->appID; ?>/<?= $row->code; ?>/" class="text-success tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View Applicant Information"><i class="fas fa-file-alt"></i></a>&nbsp; &nbsp;
                                                  
                                                    <?php if($this->session->position == 'doceval' || $this->session->position == 'asds'){?>
                                                        <a href="#" data-id="<?= $row->appID; ?>" data-toggle="modal" data-target=".bs-example-modal-center"><span class="fas fa-copy text-primary tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Copy Application"></span></a>&nbsp; &nbsp;
                                                       <?php 
                                                            $dq_res = $this->Common->three_cond_row('hris_app_dq', 'jobID',$row->jobID,'appID',$row->appID,'apID',$row->id); 
                                                            if(isset($dq_res)){
                                                            $user = $this->Common->one_cond_row('users', 'id',$dq_res->res); 
                                                       ?>
                                                       <a href="#" data-toggle="modal" data-target=".dq<?= $dq_res->id; ?>" class="text-purple"><i class="fas fa-user-check tooltips" data-placement="top" data-toggle="tooltip" data-original-title=""></i></a>
                                                       <?php } ?>
                                                       <?php if(isset($dq_res)){?>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <input type="hidden" name="id" id="id" value="">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" name="cur_id" id="position-select">
                                                                    <option></option>
