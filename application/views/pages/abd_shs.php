...
<html lang="en">
    ...
    <body class="aip_generate" id="printTable">
        ...
        <div class="cert">
            ...
            <h4 style="margin:40px 0">List of Senior High School Application</h4>
            ...
            <table class="rrr" id='myTable'>
                ...
                <tr>
                    <td><?= $ic++; ?></td>
                    <td <?php if($multi->num_rows() >= 2){echo 'style="background:#faf83e"';} ?>><a style="text-decoration:none; color:#222;" href="<?= base_url(); ?>Pages/<?= $page; ?>/<?= $id; ?>/<?= $row->jobID; ?>/<?= $row->pre_school; ?>/2" target="_blank"><?= strtoupper($a->FirstName.' '.$a->MiddleName.' '.$a->LastName); ?></a></td>
                    <td><?= $record; ?></td>
                    <td><?= $a->bd; ?></td>
