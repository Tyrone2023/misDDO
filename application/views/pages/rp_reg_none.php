<!-- ============================================================== -->
            ...
            <?php 
                ...
                // Prefer explicit appID from URL when multiple applications/retention exist
                ...
                if (empty($aa)) {
                    $aa = $this->Common->two_cond_row('hris_applications','empEmail',$staff->empEmail,'jobID',$this->uri->segment(4)); 
                }
                if (empty($aa)) {
                    $aa = $this->db
            ...
            <div class="content-page">
                                            ...
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background: #bbecfe;"><a href="<?= base_url(); ?>Pages/ies/<?= $staff->id; ?>/<?= $aa->appID; ?>/<?= $this->uri->segment(4); ?>" target="_blank" class="btn btn-info btn-sm">View</a></td>
                                                    </tr>
                                                    <?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background: #9ddcf4;">
                                                        <a href="<?= base_url(); ?>Pages/inquiry_non/<?= $staff->id; ?>/<?= $job->jobID; ?>/<?= $aa->pre_school; ?>/<?= $aa->appID; ?>" class="btn btn-info btn-sm">QUERY</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="bg-purple text-white" id="er">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left"  style="background: #9ddcf4; color:#464545">
                                                            <?php if($staff->oa != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $staff->id; ?>/oa/?label=Outstanding Accomplishments" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($canUploadDocuments){if($this->session->c_id == $user->user_id){?>
                                                                <a href="#" data-toggle="modal" data-target=".outfile"><i class="fas fa-paperclip fas btn btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Attach File"></i></a>
                                                                <?php if($staff->oa != ""){ ?><a onclick="return confirm('Are you sure?')" href="<?= base_url(); ?>Pages/remove_attachment/<?= $this->uri->segment(3).'/'. $this->uri->segment(4).'/'. $this->uri->segment(5); ?>/oa" class="btn btn-warning"><i class="mdi mdi-block-helper mr-2 text-danger tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Remove Attachment"></i>Remove Attachment</a><?php } ?>
                                                    ...
                                                    <tr>
                                                        <th class="text-right">MOV'S (Attachments)</th>
                                                        <td class="text-left"  style="background: #90bdf9; color:#464545">
                                                            <?php if($staff->ae != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $staff->id; ?>/ae/?label=Application Of Education" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($canUploadDocuments){if($this->session->c_id == $user->user_id){?>
                                                                ...
                                                                <?php if($staff->ae != ""){ ?><a onclick="return confirm('Are you sure?')" href="<?= base_url(); ?>Pages/remove_attachment/<?= $this->uri->segment(3).'/'. $this->uri->segment(4).'/'. $this->uri->segment(5); ?>/ae" class="btn btn-warning"><i class="mdi mdi-block-helper mr-2 text-danger tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Remove Attachment"></i>Remove Attachment</a><?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left"  style="background: #fde8d1; color:#464545">
                                                            <?php if($staff->ald != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $staff->id; ?>/ald/?label=Application Of Learning & Development" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($canUploadDocuments){if($this->session->c_id == $user->user_id){?>
                                                                ...
                                                                <?php if($staff->ald != ""){ ?><a onclick="return confirm('Are you sure?')" href="<?= base_url(); ?>Pages/remove_attachment/<?= $this->uri->segment(3).'/'. $this->uri->segment(4).'/'. $this->uri->segment(5); ?>/ald" class="btn btn-warning"><i class="mdi mdi-block-helper mr-2 text-danger tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Remove Attachment"></i>Remove Attachment</a><?php } ?>
                                                        ...
                                                        <td style="background: #ceeffb;">
                                                                ...
                                                                <?php if($this->session->position != "District"){ ?>
                                                                    ...
                                                                    <?php if($aa->appStatus == "Application Submitted"){ ?>
                                                                        ...
                                                                        <a class="btn btn-success btn-sm" href="<?= base_url(); ?>Pages/validated/<?= $this->uri->segment(3); ?>/<?= $this->uri->segment(4); ?>/<?= $staff->record_no; ?>/<?= $aa->appID; ?>" onclick="return confirm('By clicking OK button, you certify that you have validated the submitted documents in the system against the documents presented by the applicants.')">Validate</a>
                                                                        
                                                                        <?php } ?>
                                                                        <?php }else{ ?>
                                                                        <?php if($this->session->position == 'School'){?>
                                                                        <a class="btn btn-warning btn-sm" href="<?= base_url(); ?>Pages/undo_validated/<?= $this->uri->segment(3); ?>/<?= $this->uri->segment(4); ?>/<?= $staff->record_no; ?>/<?= $aa->appID; ?>" onclick="return confirm('Are you sure?')">Undo Validation</a>
                                                                        <?php } ?>
                                                                    <?php } ?>
                                                                <?php } ?>
                                                                ...
                                                                <?php if($aa->dq != 0){ ?>
                                                                    ...
                                                                    <?php 
                                                                        $ren = $this->Common->two_cond_count_row('hris_applications_rating', 'appID', $this->uri->segment(6),'record_no',$staff->record_no); 
                                                                        if($ren->num_rows() == 0){
                                                                    ?>
                                                                    <a href="<?= base_url(); ?>pages/ir/<?= $job->job_type; ?>/<?= $job->sy; ?>/<?= $staff->record_no; ?>/<?= $this->uri->segment(6); ?>/<?= $this->uri->segment(5); ?>/<?= $aa->jobID; ?>/<?= $this->uri->segment(3); ?>/<?= $this->uri->segment(6); ?>"  class="btn btn-primary btn-sm">Insert Rating</a>
                                                                    <?php } ?>
                                                                <?php } }  ?>
                ...
                <!-- end content -->
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                                <div class="form-group">
                                                                                    <label>Contact</label>
                                                                                    <input type="text" readonly class="form-control" name="contactNo"  value="<?= $staff->contactNo; ?>" >
                                                                                </div>	
                                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="card">
                                                                ...
                                                                <?php 
                                                                    $attributes = array('class' => 'parsley-examples');
                                                                    echo form_open_multipart('pages/update_efile_none', $attributes);
                                                                ?>
                                                                    <input type="hidden" name="id" value="<?= $staff->id; ?>">
                                                                    <input type="hidden" name="empEmail" value="<?= $staff->empEmail; ?>">
                                                                    <input type="hidden" name="jobID" value="<?= $this->uri->segment(4); ?>">
                                        ...
                                        <!--  Modal content for the above example -->
                                        <div id="myModal" class="modal fade outfile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-success">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="card">
                                                                ...
                                                                <?php 
                                                                    $attributes = array('class' => 'parsley-examples');
                                                                    echo form_open_multipart('pages/update_outfile', $attributes);
                                                                ?>
                                                                    <input type="hidden" name="id" value="<?= $staff->id; ?>">
                                                                    <input type="hidden" name="empEmail" value="<?= $staff->empEmail; ?>">
                                                                    <input type="hidden" name="jobID" value="<?= $this->uri->segment(4); ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="card">
                                                                ...
                                                                <?php 
                                                                    $attributes = array('class' => 'parsley-examples');
                                                                    echo form_open_multipart('pages/update_aefile', $attributes);
                                                                ?>
                                                                    <input type="hidden" name="id" value="<?= $staff->id; ?>">
                                                                    <input type="hidden" name="empEmail" value="<?= $staff->empEmail; ?>">
                                                                    <input type="hidden" name="jobID" value="<?= $this->uri->segment(4); ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="card">
                                                                ...
                                                                <?php 
                                                                    $attributes = array('class' => 'parsley-examples');
                                                                    echo form_open_multipart('pages/update_aldfile', $attributes);
                                                                ?>
                                                                    <input type="hidden" name="id" value="<?= $staff->id; ?>">
                                                                    <input type="hidden" name="empEmail" value="<?= $staff->empEmail; ?>">
                                                                    <input type="hidden" name="jobID" value="<?= $this->uri->segment(4); ?>">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <form class="parsley-examples" action="<?= base_url(); ?>pages/update_rate_none/<?= $this->uri->segment(3); ?>/<?= $this->uri->segment(4); ?>/0/<?= $aa->appID; ?>" method="post">
                                                                    ...
                                                                    <input type="hidden" name="message" value="TOR & CAV - College / Graduate Studies">
                                        ...
                                        <!--  Modal content for the above example -->
                                        <div id="myModal" class="modal fade trainingsrating" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-warning">
                                                        <h5 class="modal-title text-white" id="myLargeModalLabel">TRAININGS AND SEMINARS</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <div class="row">
                                        ...
                                        <!-- /.modal -->
                                         ...
                                         <!--  Modal content for the above example -->
                                        <div id="myModal" class="modal fade workrating" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-warning">
                                                        <h5 class="modal-title text-white" id="myLargeModalLabel">WORK EXPERIENCES</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <div class="row">
                                        ...
                                        <!--  Modal content for the above example -->
                                        <div id="myModal" class="modal fade performancerating" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-warning">
                                                        <h5 class="modal-title text-white" id="myLargeModalLabel">IPCRF FOR NON-TEACHING (ATTACHMENTS)</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <form class="parsley-examples" action="<?= base_url(); ?>pages/update_rate_nonev2/<?= $this->uri->segment(3); ?>/<?= $this->uri->segment(4); ?>/0/<?= $aa->appID; ?>" method="post">
                                                                    ...
                                                                    <input type="hidden" name="message" value="Performance Rating">
