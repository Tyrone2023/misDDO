        ...
        <div class="cert">
            ...
            <table class="rrr" id='myTable'>
                ...
                <tr>
                    ...
                    <td style="text-align:center; background-color:#fafcb8;"><b>STATUS</b></td>
                    ...
                    <td style="text-align:center; background-color:#fafcb8;"><b>BACHELOR'S DEGREE</b></td>
                ...
                <tr>
                    ...
                    <td><?= strtoupper($row->appStatus); ?></td>
                    <td><?= strtoupper($s->district); ?></td>
                    <td><?= strtoupper($s->schoolName); ?></td>
                    <td><?= strtoupper($jrow->jobTitle); ?></td>
                    <td><?= strtoupper($applicant->bd); ?></td>
                    <td><?php // strtoupper($applicant->specialization); ?>
                      <?php if($jrow->job_type == 1){
                        echo "";
                      }elseif($jrow->job_type == 2){
                        echo strtoupper($applicant->jhss);
                      }else{
                        echo strtoupper($applicant->shss);
                      }
                    ?>
                    </td>
                </tr>
