                                                                            ...
                                                                            <tbody>
                                                                                <?php 
                                                                                    ...
                                                                                    foreach($question as $sub_row){
                                                                                        $sbm = $this->Common->two_cond_row('sbm','school_id',$this->session->username,'fy',date('Y'));
                                                                                ...
                                                                                <tr <?php echo (++$c%2 ? "" : "class='table-active'"); ?>>
                                                                                    ...
                                                                                    <td class="text-center"><?= $sbm->$sbm_col; ?></td>
                                                                                    ...
                                                                                    <td><textarea class="form-control" name="a<?=$sub_row->i_no; ?>" rows="2" id="example-textarea"></textarea></td>
