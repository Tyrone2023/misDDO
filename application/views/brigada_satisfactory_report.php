...
<head>
    <meta charset="UTF-8">
    <title>Satisfactory Facilities Report</title>
    ...
    <div class="container mt-5">
        <div class="card shadow">
            ...
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0 text-white"><strong>Satisfactory Facilities Report</strong></h4>
            </div>

            <div class="card-body">
                <?php if (empty($satisfactory)): ?>
                    <div class="alert alert-warning">No facilities marked satisfactory.</div>
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php foreach ($satisfactory as $item): ?>
                                    <tr>
