            ...
            <?php endif;  ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h4 class="page-title">
                                    <a href="<?= base_url(); ?>Page/Addreligion">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                         ...
                                                         <a href="<?= base_url('Page/updatereligion?id=' . $row->id); ?>" 
                                                         class="btn btn-primary waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i>Edit</a>
                                                        
                                                         <a href="#" class="btn btn-danger waves-effect waves-light btn-sm" data-toggle="modal" data-target="#confirmationModal" onclick="setDeleteUrl('<?= base_url('Page/Deletereligion?id=' . $row->id); ?>')">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('Page/Deletereligion?id=' . $row->id); ?>); ?>" class="btn btn-danger" onclick="deleteData()">Delete</a>
                    </div>
                </div>
            </div>
        </div>
