...
$route['secretariat/encoders'] = 'SecretariatEncoder/index';
$route['secretariat/encoders/store'] = 'SecretariatEncoder/store';
$route['secretariat/encoders/update'] = 'SecretariatEncoder/update';
$route['secretariat/encoders/password'] = 'SecretariatEncoder/reset_password';
$route['secretariat/encoders/delete/(:num)'] = 'SecretariatEncoder/delete/$1';
$route['secretariat/field-evaluators'] = 'SecretariatFieldEvaluator/index';
$route['secretariat/field-evaluators/tag'] = 'SecretariatFieldEvaluator/tag';
$route['secretariat/field-evaluators/untag'] = 'SecretariatFieldEvaluator/untag';
$route['field-evaluator'] = 'FieldEvaluator/index';
...
$route['secretariat/retention/denied'] = 'SecretariatRetention/denied';
